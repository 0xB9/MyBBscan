...
'mytabs.php','usersocial.php','myawards.php', 'myarcade.php']
...
profilewfc = ["Profile Wii Friend", "1.0", "SQL UPDATE Injection & XSS", "https://www.exploit-db.com/exploits/23888/"]
awaylist  = ["AwayList", "1.6.7", "SQL Injection", "https://www.exploit-db.com/exploits/23625/"]
hmflags = ["HM My Country Flags", "Unknown", "SQL Injection", "https://www.exploit-db.com/exploits/23624/"]
profileskype = ["Profile Skype ID", "1.0", "SQL Injection & XSS", "https://www.exploit-db.com/exploits/23425/"]
socialsites = ["Social Sites", "0.2.2", "XSS", "https://www.exploit-db.com/exploits/23382/"]
dymy_ua = ["DyMy User Agent", "1.0", "SQL Injection", "https://www.exploit-db.com/exploits/23359/"]
profilefacebook = ["Facebook Profile", "2.4", "XSS", "https://www.exploit-db.com/exploits/23355/"]
youtube = ["MyYoutube", "1.0", "Post SQL Injection", "https://www.exploit-db.com/exploits/23353/"]
tipsoftheday = ["TipsOfTheDay", "1.0", "Stored XSS & SQL Injection", "https://www.exploit-db.com/exploits/23322/"]
profileblogs = ["Profile Blogs", "1.2", "SQL Injection & Stored XSS", "https://www.exploit-db.com/exploits/23287/"]
bank = ["Bank", "3.0", "Post SQL Injection", "https://www.exploit-db.com/exploits/23284/"]
SuscribeUsers = ["Follower User", "1.5", "SQL Injection", "https://www.exploit-db.com/exploits/22405/"]
profilealbums = ["Profile Albums", "0.9", "SQL Injection", "https://www.exploit-db.com/exploits/22003/"]
mystatus = ["MyStatus", "3.1", "SQL Injection", "https://www.exploit-db.com/exploits/17972/"]
userbar = ["Forum Userbar", "2.2", "SQL Injection", "https://www.exploit-db.com/exploits/17962/"]
afsignatures = ["Advanced Forum Signatures", "2.0.4", "SQL Injection", "https://www.exploit-db.com/exploits/17961/"]
